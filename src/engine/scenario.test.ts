...
const cfg: EngineConfig = {
  ...
  gear: {
    ...
    'stat-charm-1':    { id: 'stat-charm-1',    kind: 'statBoost', lane: 'charm',    magnitude: 1, name: 'Tailored Suit', blurb: 'Test blurb.' },
    'stat-stealth-1':  { id: 'stat-stealth-1',  kind: 'statBoost', lane: 'stealth',  magnitude: 1, name: 'Magnetic Soles', blurb: 'Test blurb.' },
    ...
    'powerup-tech':    { id: 'powerup-tech',    kind: 'powerUp',   lane: 'tech', name: 'Hackers Rig', blurb: 'Test blurb.'   },
  },
  quirks: {},
