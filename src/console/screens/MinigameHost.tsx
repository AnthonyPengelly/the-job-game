...
export function MinigameHost() {
  ...
  // Prefer the resolved variant; fall back to base game if variant not registered
  const game = resolvedGameId !== undefined ? (getGame(resolvedGameId) ?? baseGame) : baseGame;
