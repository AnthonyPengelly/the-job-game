...
- 2026-06-12: vitest now excludes **/.claude/** — agent worktrees are full repo copies and their duplicate suites ran against mismatched module identities (registry Object.is failures).
